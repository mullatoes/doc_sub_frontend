    ...
    <>
      <div className="flex items-center justify-center h-screen bg-gray-300 dark:bg-gray-900">
        <section className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 md:p-8 w-full max-w-md">
          <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white text-center">Create New Account</h1>
          <form className="space-y-4" action="#">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-gray-900 dark:text-white">Your Username</label>
              <input
                type="text"
                name="name"
                id="name"
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
              ...
              <Link to="/signin" className="font-medium text-primary-600 cursor-pointer">Sign in </Link>
            </p>
          </form>
        </section>
      </div>
